// ukladame ceny sluzeb a cenu za hdd kapacitu
export const SERVICE_PRICES = {
    OFFICE_365: 1490,
    FLASH_DRIVE: 250,
    HDD_PER_TB: 1300 // cena za kazdy 1tb (1000mb) pameti
};

// vycisteny katalog bez zbytecneho hdd objektu
...
export const SOFTWARE_CATALOG = [
    { id: 101, name: "Windows 10 Home OEM", basePrice: 2200, version: '10', edition: 'Home', licenseType: 'OEM' },
    { id: 102, name: "Windows 11 Home OEM", basePrice: 2500, version: '11', edition: 'Home', licenseType: 'OEM' },
    { id: 103, name: "Windows 11 Pro Retail", basePrice: 3800, version: '11', edition: 'Pro', licenseType: 'Retail' }
];