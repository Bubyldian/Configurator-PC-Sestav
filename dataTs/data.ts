...
export const HARDWARE_CATALOG: HardwareData[] = [
    ...
    { id: 9, name: "DDR4 16GB 3200MHz", basePrice: 900, type: 'RAM', ramType: 'DDR4' },
    { id: 10, name: "DDR5 32GB 6000MHz", basePrice: 2800, type: 'RAM', ramType: 'DDR5' },
...
export const SOFTWARE_CATALOG: SoftwareData[] = [
